...
function drawMembers(member, members, num) {
  for (var i = 0; i < members.length; i++) {
    ...
    image.innerHTML = '<image src="../images/members2026/' + members[i][0]
...
const firsts = getCsv('../csv/members_2026_34.csv');
const second = document.getElementById('second');
const seconds = getCsv('../csv/members_2026_33.csv');
const third = document.getElementById('third');
const thirds = getCsv('../csv/members_2026_32.csv');
const fourth = document.getElementById('fourth');
const fourths = getCsv('../csv/members_2026_31.csv');
