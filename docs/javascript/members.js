...
function drawMembers(member, members, num) {
  for (var i = 0; i < members.length; i++) {
    ...
    image.innerHTML = '<image src="../images/members2025/' + members[i][0]
...
const firsts = getCsv('../csv/members_2025_33.csv');
const second = document.getElementById('second');
const seconds = getCsv('../csv/members_2025_32.csv');
const third = document.getElementById('third');
const thirds = getCsv('../csv/members_2025_31.csv');
const fourth = document.getElementById('fourth');
const fourths = getCsv('../csv/members_2025_30.csv');
